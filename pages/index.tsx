  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#111] text-white px-6 pt-24">
      ...
      <p className="text-lg text-gray-300 mb-6 max-w-3xl text-center">
        Hi, I'm Calvin Moldenhauer—a full-stack developer specializing in AI, automation, and modern web technologies.
      </p>

      {/* SVG Shape Divider (Placed at the bottom of Hero Section) */}
      <div className="custom-shape-divider-bottom-1738726251 w-full">
        <svg 
          data-name="Layer 1" 
